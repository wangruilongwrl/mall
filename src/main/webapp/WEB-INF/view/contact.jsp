...
<head>
    ...
    <script type="text/javascript" src="${ctx}/static/${ctx}/static/js/jquery.js"></script>
    <script type="text/javascript" src="${ctx}/static/${ctx}/static/js/js.js"></script>
    <script src="${ctx}/static/${ctx}/static/js/wb.js" type="text/javascript" charset="utf-8"></script>
</head>
            ...
            <div class="contactBox">
                ...
                <script type="text/javascript">
                    ...
                    function createIcon(json){
                        var icon = new BMap.Icon("http://app.baidu.com/map/${ctx}/static/images/us_mk_icon.png", new BMap.Size(json.w,json.h),{imageOffset: new BMap.Size(-json.l,-json.t),infoWindowOffset:new BMap.Size(json.lb+5,1),offset:new BMap.Size(json.x,json.h)})
                        return icon;
                    }
